...
/*
    ...
    public ApiResponseDto<SuccessResponse> signOut(User user, String accessToken)
    {
        ...
        return ResponseUtils.ok(SuccessResponse.of(HttpStatus.OK, "회원탈퇴 완료"), ErrorResponse.builder().status(200).message("요청 성공").build());
    }
